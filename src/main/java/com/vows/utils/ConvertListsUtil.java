...
/**
 * @project:webasic
 * @description:数组、List、Set、Map相互转换
 * @authur:nis36
 * 2017年2月2日-下午5:01:41
 * 2017  PD.Sp Center   -版权所有
 */
public class ConvertListsUtil {
	/**
	 * map2List
	 * @exception
	 * @since  1.0.0
	*/
	private static List<String> mapKey2List( Map<String, String> map ) {  
        // 将Map Key 转化为List      
	...
	private static List<String> mapVal2List( Map<String, String> map ){
		  // 将Map Key 转化为List      
    ...
    private static Set<String> array2Set() {  
